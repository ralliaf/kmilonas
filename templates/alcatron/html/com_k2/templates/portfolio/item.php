		<div class="portfolio-top-banner">
		<h3>ΕΡΓΑ</h3>
		</div>	
			<div class="row">
...
<!-- End K2 Item Layout -->
					...
					<div class="t3-sidebar t3-sidebar-2 span4">
						<div class="module-inner">
							<h3 class="module-title">Πληροφοριακα Στοιχεια</h3>
	...
	<div class="itemHeader">
	  ...
	  <?php endif; ?>
					...
					<!--	<div class="module-inner">
							<h3 class="module-title">What we did</h3>
						  <?php //if($this->item->params->get('itemImageGallery') && !empty($this->item->gallery)): ?>
						  <!-- Item image gallery -->
						 <!-- <a name="itemImageGalleryAnchor" id="itemImageGalleryAnchor"></a>
						  <div class="itemImageGallery">
			...
			<div class="row moduletablerecentWorks">		
						<h3>Ενδεικτικα Εργα</h3>
						<div class="controller">
					<a class="prev" id="slide_prev" href="#"><img src="templates/alcatron/images/arrow_left.png" alt="Previous" /></a>
					<a class="next" id="slide_next" href="#"><img src="templates/alcatron/images/arrow_right.png" alt="Next" /></a>
					</div>
		...
		<div class="row single_page">
			<div class="large-12 columns">				
				...
				<img src="<?php echo $item->image; ?>" alt="<?php K2HelperUtilities::cleanHtml($item->title); ?>" />
				<?php endif; ?> 
								<div class="mask"> 
									<h4><?php echo $item->title; ?></h4>
									<p><?php echo $item->introtext; ?></p>
									<!--<a class="button btn-icon" href="<?php echo $item->image; ?>" data-rel="prettyPhoto"><i class="icon-zoom-in icon-large"></i></a>-->
									<a class="button btn-icon icon-2" href="<?php echo $item->link; ?>"><i class="icon-external-link icon-large"></i></a> 
								</div>
							</div>
						</li>
						<?php endforeach; ?>
