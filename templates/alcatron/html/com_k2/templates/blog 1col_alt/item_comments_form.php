...
<form action="<?php echo JURI::root(true); ?>/index.php" method="post" id="comment-form contact" class="form-validate">
    ...
    <div class="inbox1">
	<input class="inputbox1" type="text" name="userName" id="userName" value="<?php echo JText::_('Name'); ?>" onblur="if(this.value=='') this.value='<?php echo JText::_('Name'); ?>';" onfocus="if(this.value=='<?php echo JText::_('KName'); ?>') this.value='';" />
	</div>
